...
export default function ProfilingAge() {
    ...
    <div className="min-h-screen bg-[#FFF8F0] flex flex-col max-w-[360px] mx-auto">
      <div className="p-6">
        <div className="mb-2 h-2 bg-white rounded-full">
          <div className="h-full w-[60%] bg-[#FF6B35] rounded-full transition-all" />
        </div>
        <p className="text-sm text-[#1A1A1A]/60 mb-8">Step 3 of 5</p>

        <div className="mb-12">
          <h2 className="mb-2">Aapki umar kya hai?</h2>
          <p className="text-[#1A1A1A]/70">Age ke hisaab se planning alag hogi</p>
        </div>
