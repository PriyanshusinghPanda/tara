...
export default function ProfileAge() {
  ...
  const options = [
    { value: '18-25', label: '18 - 25 years', emoji: '🎓' },
    { value: '26-35', label: '26 - 35 years', emoji: '💼' },
    { value: '36-45', label: '36 - 45 years', emoji: '👨‍👩‍👧' },
    { value: '46+', label: '46+ years', emoji: '🧓' },
  ];
    ...
    <div className="h-screen flex flex-col bg-[#FFF8F0]">
      <div className="px-6 pt-8 pb-6 flex items-center justify-between">
        ...
        <div className="flex-1 mx-4 bg-[#FFE5D9] rounded-full h-2">
          <div className="bg-[#FF6B35] h-2 rounded-full" style={{ width: '60%' }}></div>
        </div>
        <span className="text-[#8E8E93] text-[16px]">3/5</span>
      </div>
      ...
      <div className="flex-1 px-6">
        <div className="mb-8">
          ...
          <p className="text-[#8E8E93] text-[19px]">
            Age-specific tips dene ke liye
          </p>
        </div>
