...
export default function ProfileGoal() {
  ...
  const options = [
    { value: 'save', label: 'Zyada paise bachane hain', emoji: '🐷' },
    { value: 'debt', label: 'Loan jaldi clear karna hai', emoji: '🎯' },
    { value: 'purchase', label: 'Badi cheez leni hai (bike/phone)', emoji: '🏍️' },
    { value: 'learn', label: 'Paiso ke baare mein seekhna hai', emoji: '📚' },
  ];
    ...
    <div className="h-screen flex flex-col bg-[#FFF8F0]">
      <div className="px-6 pt-8 pb-6 flex items-center justify-between">
        ...
        <div className="flex-1 mx-4 bg-[#FFE5D9] rounded-full h-2">
          <div className="bg-[#FF6B35] h-2 rounded-full" style={{ width: '100%' }}></div>
        </div>
        <span className="text-[#8E8E93] text-[16px]">5/5</span>
      </div>
      
      <div className="flex-1 px-6">
        <div className="mb-8">
          <h2 className="text-[#1A1A1A] mb-3">
            Aapka main goal<br />kya hai?
          </h2>
          <p className="text-[#8E8E93] text-[19px]">
            Sabse pehle kya achieve karna hai?
          </p>
        </div>
