                ...
                try:
                    ...
                    if date_time_Str >= date_time_str:
                        ...
                        if j!=-1:
                            ...
                            prediction_result = predict_transaction(s, spend, date_time_Str)
                            p = [prediction_result['category']]
                            print(f"Prediction: {p[0]} (Confidence: {prediction_result['confidence']:.2f})")
